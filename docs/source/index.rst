...
We created **Oakvar-Longevity** which is a module of OakVar. It annotates user genome with longevity associated gene variants using the longevitymap annotator, and provides longevity PRS, variants, drugs and major risks(oncorisk) reports with longevity-combinedreporter.

Check out the :doc:`getting_started` section for further information, including
the section :ref:`assemblies` to understand whether you have the appropriate genome assembly.
